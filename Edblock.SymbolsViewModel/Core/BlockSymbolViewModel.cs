...
public abstract class BlockSymbolViewModel : ObservableObject
{
    ...
    public BlockSymbolViewModel(EditorVM edblockVM)
    {
        EdblockVM = edblockVM;
    ...
    public void ShowAuxiliaryElements()
    {
        ...
        {
            symbolHasTextField.TextFieldSymbol.Cursor = Cursors.SizeAll;
        }
    }
