...
public class InputOutputSymbolViewModel : BlockSymbolViewModel, IHasTextField, IHasConnection, IHasScaleRectangles
{
    ...
    public InputOutputSymbolViewModel(EditorViewModel editorViewModel) : base(editorViewModel)
    {
