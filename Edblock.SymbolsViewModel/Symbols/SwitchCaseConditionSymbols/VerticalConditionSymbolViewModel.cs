...
public class VerticalConditionSymbolViewModel : SwitchCaseSymbolViewModel, IHasTextField, IHasConnection, IHasScaleRectangles
{
    ...
    public VerticalConditionSymbolViewModel(EditorViewModel editorViewModel, int countLines) : base(editorViewModel, countLines)
    {
