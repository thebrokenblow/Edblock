...
[SymbolType("HorizontalConditionSymbolViewModel")]

public class HorizontalConditionSymbolViewModel : SwitchCaseSymbolViewModel, IHasTextField, IHasConnection, IHasScaleRectangles
{
    ...
    public HorizontalConditionSymbolViewModel(EditorViewModel editorViewModel, int countLines) : base(editorViewModel, countLines)
    {
