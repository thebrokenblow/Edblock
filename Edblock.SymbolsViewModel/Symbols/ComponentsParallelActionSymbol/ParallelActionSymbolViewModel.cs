...
namespace Edblock.SymbolsViewModel.Symbols.ComponentsParallelActionSymbol;

[SymbolType("ParallelActionSymbolVM")]
public class ParallelActionSymbolViewModel : BlockSymbolViewModel, IHasConnection
{
    public LineParallelActionSymbol UpperHorizontalLine { get; set; } = new();
    public LineParallelActionSymbol LowerHorizontalLine { get; set; } = new();
    ...
    public ParallelActionSymbolViewModel(EditorViewModel editorViewModel, int countSymbolsIncoming, int countSymbolsOutgoing) : base(editorViewModel)
    {
