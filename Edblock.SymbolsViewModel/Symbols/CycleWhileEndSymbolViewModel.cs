...
[SymbolType("CycleWhileEndSymbolViewModel")]

public class CycleWhileEndSymbolViewModel : BlockSymbolViewModel, IHasTextField, IHasConnection, IHasScaleRectangles
{
    ...
    public CycleWhileEndSymbolViewModel(EditorViewModel editorViewModel) : base(editorViewModel)
    {
    ...
    {
        var heightWithSideProjection = Height - sideProjection;
        var widthWithSideProjection = Width - sideProjection;

        Points =
        [
            new(0, 0),
            new(0, heightWithSideProjection),
            new(sideProjection, Height),
            new(widthWithSideProjection, Height),
            new(Width, heightWithSideProjection),
            new(Width, 0),
        ];
    }
