...
namespace Edblock.SymbolsViewModel.Symbols.ComponentsSymbolsVM;

public class TextFieldSymbol : INotifyPropertyChanged
{
    ...
    public TextFieldSymbol(CanvasSymbolsViewModel canvasSymbolsViewModel, BlockSymbolViewModel blockSymbolVM)
    {
    ...
    public static void ChangeFocus(ObservableCollection<BlockSymbolViewModel> Symbols)
    {
        foreach (var symbol in Symbols)
        {
            if (symbol is IHasTextField blockTextFieldVM)
            {
    ...
    {
        _canvasSymbolsViewModel.Cursor = Cursors.IBeam;
