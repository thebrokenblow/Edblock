...
namespace Edblock.SymbolsViewModel.Symbols.ComponentsCommentSymbol;
...
public class CommentSymbolViewModel : BlockSymbolViewModel, IHasTextField
{
    ...
    public CommentSymbolViewModel(EditorViewModel editorViewModel) : base(editorViewModel)
    {
        _canvasSymbolsViewModel = editorViewModel.CanvasSymbolsVM;
        ...
        TextFieldSymbolVM = new(_canvasSymbolsViewModel, this)
        {
            Text = defaultText,
