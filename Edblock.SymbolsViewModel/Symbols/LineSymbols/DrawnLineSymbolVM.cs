...
public class DrawnLineSymbolVM : INotifyPropertyChanged
{
    ...
    private BlockSymbolViewModel? symbolOutgoingLine;
    public BlockSymbolViewModel? SymbolOutgoingLine
    {
    ...
    private BlockSymbolViewModel? symbolIncomingLine;
    public BlockSymbolViewModel? SymbolIncomingLine
    {
