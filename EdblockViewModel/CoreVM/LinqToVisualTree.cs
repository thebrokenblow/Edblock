...
/// a Linq To Tree API
/// </summary>
public class VisualTreeAdapter(DependencyObject dependencyObject) : ILinqTree<DependencyObject>
{
...
public static class TreeExtensions
{
    ...
    {
        foreach (var child in new VisualTreeAdapter(item).Children())
        {
            yield return child;
