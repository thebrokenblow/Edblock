...
/// </summary>
public partial class ParallelActionSymbolUI : UserControl, IFactorySymbolViewModel
{
    ...
    public BlockSymbolViewModel CreateBlockSymbolViewModel(EditorViewModel editorViewModel)
    {
        ...
        return new ParallelActionSymbolViewModel(editorViewModel, countSymbolsIncoming, countSymbolsOutgoing); ;
    }
}